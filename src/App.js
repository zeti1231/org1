...
function App() {
  ...
  //Ternario --> condición ? : noSeMuestra
  //condicion && seMuestra
    ...
    <div>
...

      {
        equipos.map((equipo) => <Equipo
          ...
          eliminarColaborador={eliminarColaborador}/*el primer eliminarColaborador, es el nombre de una prop, el segundo hace referencia a la función de la línea 61*/
